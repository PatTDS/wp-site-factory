<footer class="bg-gray-900 text-gray-300">
    <div class="container mx-auto px-4 py-12">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
                <h3 class="text-white text-lg font-semibold mb-4">
                    <?php _e('Quick Links', 'anywhere_solutions-theme'); ?>
                </h3>
                <?php
                wp_nav_menu([
            ...
            <div>
                <h3 class="text-white text-lg font-semibold mb-4">
                    <?php _e('Contact', 'anywhere_solutions-theme'); ?>
                </h3>
                <ul class="space-y-3 text-sm">
                    <li class="flex items-start">
                        ...
                        <span>42 Industrial Avenue<br>Welshpool WA 6106</span>
                    </li>
                    <li class="flex items-center">
                        ...
                        <a href="tel:+61893456789" class="hover:text-white transition-colors">(08) 9345 6789</a>
                    </li>
                    <li class="flex items-center">
                        <svg class="w-5 h-5 mr-3 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        <a href="mailto:info@anywheresolutions.com.au" class="hover:text-white transition-colors">info@anywheresolutions.com.au</a>
                    </li>
                    <li class="flex items-center">
                        <svg class="w-5 h-5 mr-3 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="border-t border-gray-800">
        <div class="container mx-auto px-4 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
                <p>&copy; <?php echo date('Y'); ?> <?php bloginfo('name'); ?>. <?php _e('All rights reserved.', 'anywhere_solutions-theme'); ?></p>
                <p class="mt-2 md:mt-0">
                    <?php _e('Developed with', 'anywhere_solutions-theme'); ?> ❤️
                </p>
            </div>
        </div>
    </div>
